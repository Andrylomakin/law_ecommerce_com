...
class SettingController extends Controller
{
    ...
    {
        $fields = ['domain', 'google_tags', 'google_tags_conversion', 'fb_pixel', 'verification_domain', 'logo', 'telegram_tittle', 'stylesheet', 'email', 'telegram_chat_id', 'telegram_token', 'telegram', 'viber', 'whatsapp','google_tags_conversion_social', 'fb_conversion_social'];
        $radioFields = [
    ...
    {
        $fields = ['google_tags', 'google_tags_conversion', 'fb_pixel', 'verification_domain', 'logo', 'telegram_tittle', 'stylesheet', 'email', 'telegram_chat_id', 'telegram_token', 'telegram', 'viber', 'whatsapp','google_tags_conversion_social', 'fb_conversion_social'];
        $radioFields = [
            'determine_language_by' => [
                'type'   => 'radio',
                'title'  => 'Определять язык',
