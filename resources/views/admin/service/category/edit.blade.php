        ...
        <div class="card-header">
            <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                    <h5 class="mb-0">Создание/Редактирование категории</h5>
                </div>
            </div>
        </div>
        <form action="{{ route('admin.service.category.change', $category->id) }}" method="post"
              enctype="multipart/form-data" data-tabs class="tabs-admin">
            @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group mb-3">
                                            <input class="form-control"
                                                   ...
                                                   value="{{ isset($category->name[$language['code']]) ? $category->name[$language['code']] : '' }}"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group mb-3">
                                            <input class="form-control"
                                                   ...
                                                   value="{{ isset($category->seo_title[$language['code']]) ? $category->seo_title[$language['code']] : '' }}"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group mb-3">
                                            <input class="form-control"
                                                   ...
                                                   value="{{ isset($category->seo_description[$language['code']]) ? $category->seo_description[$language['code']] : '' }}"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control"
                                                  ...
                                                  type="text">{!! isset($category->seo_text[$language['code']]) ? $category->seo_text[$language['code']] : ''  !!}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <input class="form-control" id="title" value="{{ $category->slug }}" name="slug"
                               type="text">
                    </div>
                </div>
                <div class="row mt-4">
