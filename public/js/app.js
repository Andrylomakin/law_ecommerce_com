(() => {
    ...
    (() => {
        ...
        if (baronElements.length > 0) baronElements.forEach((function(element) {
        ...
        let formValidate = {
            ...
            phoneTest(formRequiredItem) {
                return !/^\s*\+\s*\d{9,12}\s*$/.test(formRequiredItem.value);
            },
            ...
            if (document.querySelector(".reviews__slider")) new swiper_core_Swiper(".reviews__slider", {
                ...
                on: {
                    ...
                    slideChange: function(swiper) {
                        ...
                        const currentSlideNumber = swiper.realIndex + 1;
                        currentSlide.innerHTML = currentSlideNumber.toString();
                    }
                }
            });
        }
        ...
        function rearrangeElements() {
            ...
            var items = document.querySelectorAll(".service-more__item");
            items.forEach((function(item) {
                var wrap = item.querySelector(".service-more__wrap");
                var block = item.querySelector(".service-more__block");
                var info = item.querySelector(".service-more__info");
                if (screenWidth < breakpoint) wrap.appendChild(info); else block.appendChild(info);
            }));
        }
        ...
        function simulateButtonClick() {
            var siteClosed = sessionStorage.getItem("siteClosed");
            if (!siteClosed) modules_flsModules.popup.open("#popup-form");
            operationCount++;
            if (operationCount >= 2) clearInterval(recurringActionInterval);
        }
        function performActions() {
            simulateButtonClick();
        }
        var recurringActionInterval;
        setTimeout((function() {
            performActions();
        ...
        var watcherCounter = document.getElementById("watcher-counter");
        if (watcherCounter) {
            "use strict";
            ...
            function windowLoad() {
                ...
                function watch(selector) {
                    ...
                    const observer = new IntersectionObserver((entries => {
                        entries.forEach((element => {
                            if (element.isIntersecting === true && flag === true) {
                                flag = false;
                                const digitsCountersItems = el.querySelectorAll("[data-digits-counter]");
                ...
                watch("#watcher-counter");
            }
        }
        const textBlocks = document.querySelectorAll(".services-tabs__text, .page-service__text, .content__body, .service-content__wrap");
        textBlocks.forEach((block => {
            let textContent = block.innerHTML;
